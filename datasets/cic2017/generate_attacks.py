#!/usr/bin/env python3
"""CIC-IDS2017 — Generate adversarial attacks.

Usage::

    python -m datasets.cic2017.generate_attacks --run-dir results/cic2017/<ts>_prepare
"""
...
def main():
    parser = argparse.ArgumentParser(description="CIC-IDS2017 — Generate attacks")
    ...
    header("Generate Attacks", dataset="cic2017")
    ...
    out = create_run_dir(base, "cic2017", "attacks")
