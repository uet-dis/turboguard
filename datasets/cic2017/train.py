#!/usr/bin/env python3
"""CIC-IDS2017 — Train TurboGuard + baseline models.

Usage::

    python -m datasets.cic2017.train --run-dir results/cic2017/<ts>_prepare
"""
...
def main():
    parser = argparse.ArgumentParser(description="CIC-IDS2017 — Train models")
    ...
    if not args.skip_baseline:
        header("Train Baselines", dataset="cic2017")
        bl_dir = create_run_dir(base, "cic2017", "baseline")
    ...
    if not args.skip_turboguard:
        header("Train TurboGuard", dataset="cic2017")
        tg_dir = create_run_dir(base, "cic2017", "turboguard")
        ...
        # Display calibration sweep table in console
        ...
        # Save full calibration sweep for reproducibility
