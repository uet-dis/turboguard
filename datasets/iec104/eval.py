#!/usr/bin/env python3
"""IEC104 — Evaluate TurboGuard against generated attacks.

Usage::

    python -m datasets.iec104.eval \\
...
def main():
    parser = argparse.ArgumentParser(description="IEC104 — Evaluate")
    ...
    header("Evaluate Benchmark (Sector C)", dataset="iec104")
    ...
    out = create_run_dir(base, "iec104", "eval")

    with open(out / "report.json", "w") as f:
        json.dump(results, f, indent=2)

    lines = ["Benchmark Evaluation — IEC104", "=" * 60]
