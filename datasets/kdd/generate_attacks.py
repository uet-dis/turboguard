#!/usr/bin/env python3
"""KDD — Generate adversarial attacks.

Usage::

    python -m datasets.kdd.generate_attacks --run-dir results/unsw/<ts>_prepare
"""
...
def main():
    parser = argparse.ArgumentParser(description="KDD — Generate attacks")
    ...
    header("Generate Attacks", dataset="kdd")
    ...
    out = create_run_dir(base, "kdd", "attacks")
