#!/usr/bin/env python3
"""UNSW — Generate adversarial attacks.

Usage::

    python -m datasets.unsw.generate_attacks --run-dir results/unsw/<ts>_prepare
"""
...
def main():
    parser = argparse.ArgumentParser(description="UNSW — Generate attacks")
    ...
    header("Generate Attacks", dataset="unsw")
    ...
    out = create_run_dir(base, "unsw", "attacks")
