#!/usr/bin/env python3
"""IEC104 — Generate adversarial attacks.

Usage::

    python -m datasets.iec104.generate_attacks --run-dir results/unsw/<ts>_prepare
"""
...
def main():
    parser = argparse.ArgumentParser(description="IEC104 — Generate attacks")
    ...
    header("Generate Attacks", dataset="iec104")
    ...
    out = create_run_dir(base, "iec104", "attacks")
