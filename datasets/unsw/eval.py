#!/usr/bin/env python3
"""UNSW — Evaluate TurboGuard against generated attacks.

Usage::

    python -m datasets.unsw.eval \\
...
def main():
    parser = argparse.ArgumentParser(description="UNSW — Evaluate")
    ...
    header("Evaluate Benchmark (Sector C)", dataset="unsw")
    ...
    out = create_run_dir(base, "unsw", "eval")

    with open(out / "report.json", "w") as f:
        json.dump(results, f, indent=2)

    lines = ["Benchmark Evaluation — UNSW", "=" * 60]
